...
/**
 * Описываем базовый абстрактный класс MODEL, который будет использоваться (наследоаться) в классах сущностей MODAL (КАРТОЧКА ТОВАРА, ЗАКАЗ, описание приложения (AppState))
 */
